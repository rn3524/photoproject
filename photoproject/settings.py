...
AUTH_USER_MODEL = 'accounts.CustomUser' # Userモデルの代わりにCustomUserモデルを使用する

EMAIL_BACKEND = 'django.core.mail.backends.condole.EmailBackend'
...
LOGIN_REDIRECT_URL ='photo:index' # ログインごのリダイレクト先